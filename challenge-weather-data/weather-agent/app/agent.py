...
from app.online_research_agent import online_research_agent
from app.bigquery_research_agent import bigquery_research_agent
...
root_agent = Agent(
    ...
    # sub_agents=[bigquery_research_agent, online_research_agent],
